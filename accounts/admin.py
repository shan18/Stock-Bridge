...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('full_name', 'cash', 'loan', 'loan_count', 'coeff_of_variation', 'news_count')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': (
                'username', 'email', 'full_name', 'cash', 'loan', 'loan_count', 'coeff_of_variation', 'news_count', 'password1', 'password2'
            )}
         ),
    )
